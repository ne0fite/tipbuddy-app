...
class AvgTipsLineChart extends Component {
  getLabels = (tips) => {
  ...
  getData = tips => (
    _.map(tips, tipSummary => tipSummary.amountAvg)
  )
  ...
  render() {
    ...
    return (
      <View>
        <Subheading>Average Tips</Subheading>
        <LineChart
          data={chartData}
          width={chartWidth}
          height={180}
...
export default withTheme(AvgTipsLineChart);
