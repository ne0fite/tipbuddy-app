...
class AvgSalesLineChart extends Component {
  getLabels = (tips) => {
  ...
  getData = tips => (
    _.map(tips, tipSummary => tipSummary.salesAvg)
  )
  ...
  render() {
    ...
    return (
      <View>
        <Subheading>Average Sales</Subheading>
        <LineChart
          data={chartData}
          width={chartWidth}
          height={180}
...
export default withTheme(AvgSalesLineChart);
